...
namespace TempestEngine
{
    ...
    public:
        ...
        static float dot(const Vector4 &from, const Vector4 &to)
        ...
        static float magnitude(const Vector4 &Vector, const Vector4 &Vector2)
        {                                                                                                                                               // Returns a flaot, this is the magnitude. The formula is: sqrt(each coordinate property^2)
        ...
        { // Returns a NEW vector. Example usage would be Vector4 Added = Vector4(2, 5, 1) + Vector(1, 0, 5) = Vector4(3, 5, 6)
            return Vector4(x + other.x, y + other.y, z + other.z, w + other.w);
        }
        Vector4 operator-(const Vector4 &other)
        { // Returns a NEW vector. Example usage would be Vector4 Subtracted = Vector4(2, 5, 1) - Vector(1, 0, 5) = Vector4(3, 5, 6)
            return Vector4(x - other.x, y - other.y, z - other.z, w - other.w);
        }
        ...
        { // Modifies this vector to a certain scale. Example of this would be: Vector4 MovementVector *= 9.82f
            x *= scalar;
            y *= scalar;
            z *= scalar;
            w *= scalar;
        ...
        { // Modifies this vector. Example of this would be: Vector4 PushVector (it's downwards) += Vector4 GravitationalVector
            x += other.x;
            y += other.y;
            z += other.z;
            w += other.w;
        ...
        void operator-=(const Vector4 &other)
        { // Modifies this vector. Example of this would be: Vector4 PushVector (it's sideways along a surface that has friction) -= Vector4 FrictionVector
            x -= other.x;
            y -= other.y;
            z -= other.z;
            w -= other.w;
